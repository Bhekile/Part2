...
<form action="<?php echo $_SERVER["PHP_SELF"];?>" enctype = "multipart/form-data" method = "post">
    <p style="color:#8ae600">Please fill in this form to create an account.</p>
    <hr>
    ...
    <a>
    <button type="submit" style="color:#8ae600; font-size: 100%; font-family: inherit; border: none; padding: 0!important; background: none!important; 
